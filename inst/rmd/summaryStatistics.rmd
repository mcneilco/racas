...
if (numExpProtUsers[3] == 0) {
  ...
  plot <- plot + theme(axis.text.x = element_text(angle=40, vjust=.8, hjust=1))
  plot
}
```
...
if (numExpProtUsers[3] == 0) {
  ...
  plot1 <- plot1 + theme(axis.title = element_text(size = rel(1.3)), 
                         plot.title = element_text(size = rel(2)),
                         axis.text = element_text(size = rel(1.3)))
  plot1 <- plot1 + theme(axis.text.x = element_text(angle=40, vjust=.8, hjust=1))
  plot1
}
```
