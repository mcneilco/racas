...
modelEquation <- switch(fitData[1]$renderingHint,
                        "4 parameter D-R" = get_text_file_contents(system.file(file.path("rmd","equations"), "ll4.txt", package = "racas")),
                        "Ki Fit" = get_text_file_contents(system.file(file.path("rmd","equations"), "ki.txt", package = "racas"))
                        )
cat(modelEquation)
```
