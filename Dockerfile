...
RUN  Rscript -e 'options(repos = c(CRAN="http://cran.rstudio.com/"));install.packages("miniCRAN");source("/home/runner/racas/R/installation.R");makeRepo("/home/runner/racas/repo")'
