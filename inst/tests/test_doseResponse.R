...
test_that("doseResponse.fitData for ll4 easy curve tests",{
  file <- system.file("tests","data", "doseResponse","default-ll4-fitSettings.json", package = "racas")
  fitSettings <- fromJSON(readChar(file, file.info(file)$size))
  load(system.file("tests","data", "doseResponse","example-ll4-fitData.rda", package = "racas"))
...
test_that("simpleToAdvancedFitSettings for ll4",{
  ...
  acceptedResultsPath <- file.path("data","doseResponse", "simpleToAdvancedFitSettings.LL4_acceptedResults.rda")
  newResults <- simpleToAdvancedFitSettings(simpleSettings)
  rdaTest(newResults, acceptedResultsPath, updateResults = updateResults)
})

test_that("getDefaultFitSettings for ll5",{
...
test_that("predictPoints basic test",{
  load(system.file("tests","data", "doseResponse", "example-ll4-fitData-fitted.rda", package = "racas"))
...
test_that("kd fits still biphasic",{
  file <- system.file("tests","data", "doseResponse","default-ll4-fitSettings.json", package = "racas")
  fitSettings <- fromJSON(readChar(file, file.info(file)$size))
  load(system.file("tests","data", "doseResponse", "example-ll4-fitData.rda", package = "racas")) 
  acceptedResultsPath <- file.path("data","doseResponse", "biphasic_acceptedResults.rda")
