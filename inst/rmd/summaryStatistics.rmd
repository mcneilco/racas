...
```{r history, echo=FALSE, results='asis', fig.show='hold', fig.width=figWidth, fig.height=4, cache=FALSE}
if (is.null(history)) {
...
```{r progress, echo=FALSE, results='asis', fig.show='hold', fig.width=figWidth, fig.height=4, cache=FALSE}
if (is.null(progress)) {
...
cat("Summary statistics generated on ", date(), ". Data can be downloaded at ",
    paste("http://", racas::applicationSettings$client.host, ":", 
